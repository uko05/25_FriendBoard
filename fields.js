...
const OPTION_LABELS = {
  ...
  playStyles: {
    ...
    canHelpDomain: { ja: '秘境周回手伝います！', en: "I'll help you farm domains!" },
    canCarry: { ja: 'キャリーします！', en: "I'll carry you!" },
    canHelpIllusive: { ja: '幽境の激戦手伝います！', en: "I'll help with the Illusive Realm's Trounce Domain!" },
    needIllusiveHelp: { ja: '幽境の激戦手伝って！', en: "Help me with the Illusive Realm's Trounce Domain!" },
