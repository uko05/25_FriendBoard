document.addEventListener("DOMContentLoaded", () => {
  ...
  const dict = {
    ja: {
      ...
      prefOppositeGender: "異性のフレンドがほしい",
      prefAnyGender: "男女問わずフレンドがほしい",
      prefWantArtFriend: "お絵描き友達がほしい",
    ...
    en: {
      ...
      jokingEither: "Either way with joking",
      jokingNo: "Not into joking around",
      labelYuriOk: "Yuri",
      yuriOkLabel: "Into yuri (girls' love)",
      yuriEither: "Either way with yuri",
      yuriNo: "Not into yuri",
      labelFujoshiOk: "BL",
      fujoshiOkLabel: "Into BL (boys' love)",
      fujoshiEither: "Either way with BL",
      fujoshiNo: "Not into BL",
      labelYumeOk: "Yume",
      yumeOkLabel: "Into yume (self-insert)",
      yumeEither: "Either way with yume",
      yumeNo: "Not into yume",
      labelRoughTalk: "Rough language",
      roughTalkNo: "No rough language",
      roughTalkEither: "Either way with rough language",
      ...
      prefOppositeGender: "Looking for an opposite-gender friend",
      prefAnyGender: "Gender doesn't matter",
      prefWantArtFriend: "Looking for a drawing/art friend",
