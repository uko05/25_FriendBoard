document.addEventListener("DOMContentLoaded", () => {
  ...
  const dict = {
    ja: {
      ...
      styleCanHelpDomain: "秘境周回手伝います！",
      styleCanCarry: "キャリーします！",
      styleCanHelpIllusive: "幽境の激戦手伝います！",
      styleNeedIllusiveHelp: "幽境の激戦手伝って！",
    ...
    en: {
      ...
      styleCanHelpDomain: "I'll help you farm domains!",
      styleCanCarry: "I'll carry you!",
      styleCanHelpIllusive: "I'll help with the Illusive Realm's Trounce Domain!",
      styleNeedIllusiveHelp: "Help me with the Illusive Realm's Trounce Domain!",
