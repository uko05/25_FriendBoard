document.addEventListener("DOMContentLoaded", () => {
  ...
  const dict = {
    ja: {
      ...
      vcMaybe: "相談",
      labelVcNote: "VC相談の詳細",
      vcNotePlaceholder: "例）夜だけなら相談可能です",
      labelVcApps: "VC利用アプリ",
      ...
      labelComment: "なんでも一言",
      commentPlaceholder: "別ゲー○○のフレンドも募集中！とか無言加入歓迎！とか下ネタ/暴言OK NGとか他に書きたいことがあれば書いておこう！",
      postSubmitBtn: "保存する",
    ...
    en: {
      ...
      vcNotePlaceholder: "e.g. Only possible at night, ask me",
      labelVcApps: "VC App",
      vcAppDiscord: "Discord",
      vcAppLine: "LINE",
      vcAppOther: "Other",
      ...
      commentPlaceholder: "e.g. \"Also looking for friends on [other game]!\", \"silent adds welcome!\", \"dirty jokes/cursing OK or NG\" — write anything else you'd like to share!",
      postSubmitBtn: "Save",
